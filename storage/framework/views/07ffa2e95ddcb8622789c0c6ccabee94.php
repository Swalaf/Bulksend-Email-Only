...
<head>
    ...
    <title><?php echo e(__('Login')); ?> - <?php echo e(config('app.name', 'BulkSend')); ?></title>

    <!-- Primary Meta Tags -->
    <meta name="title" content="<?php echo e(__('Login')); ?> - <?php echo e(config('app.name', 'BulkSend')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-white/80 hover:text-white transition-colors font-medium">
                                    Forgot password?
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="text-center mt-8">
                        <p class="text-white/80">
                            New to BulkSend?
                            <a href="<?php echo e(route('register')); ?>" class="text-white hover:text-white/80 font-semibold ml-1 transition-colors">
                                Create Account →
                            </a>
                        </p>
                    </div>
