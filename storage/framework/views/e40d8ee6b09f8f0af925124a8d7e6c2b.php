...
<head>
    ...
    <title><?php echo e(config('app.name', 'BulkSend')); ?> - <?php echo e($title ?? 'Dashboard'); ?></title>

    <!-- Primary Meta Tags -->
    <meta name="title" content="<?php echo e(config('app.name', 'BulkSend')); ?> - <?php echo e($title ?? 'Dashboard'); ?>">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="relative" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 glass-effect rounded-xl shadow-lg py-2 z-50">
                                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-4 py-2 text-sm text-primary-700 hover:bg-primary-50 transition-colors">
                                            <i class="fas fa-user mr-3"></i>Profile
                                        </a>
                                        <a href="<?php echo e(route('billing.index')); ?>" class="flex items-center px-4 py-2 text-sm text-primary-700 hover:bg-primary-50 transition-colors">
...
<?php /**PATH /Users/user/Desktop/Bulksend Email Only/resources/views/layouts/app.blade.php ENDPATH**/ ?>