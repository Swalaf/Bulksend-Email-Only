...
<?php $component->withAttributes(['title' => 'Dashboard']); ?>
        ...
        <div class="glass-effect rounded-2xl p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-scale-in" style="animation-delay: 0.1s;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-primary-900"><?php echo e($stats['total_campaigns'] ?? 0); ?></p>
        ...
        <div class="glass-effect rounded-2xl p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-scale-in" style="animation-delay: 0.2s;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-primary-900"><?php echo e($stats['total_subscribers'] ?? 0); ?></p>
                    <div class="flex items-center mt-2">
                        <i class="fas fa-arrow-up text-accent-500 mr-1"></i>
        ...
        <div class="glass-effect rounded-2xl p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-scale-in" style="animation-delay: 0.3s;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-primary-900"><?php echo e(number_format($stats['emails_sent'] ?? 0)); ?></p>
                    <div class="flex items-center mt-2">
                        <i class="fas fa-arrow-up text-accent-500 mr-1"></i>
        ...
        <div class="glass-effect rounded-2xl p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-scale-in" style="animation-delay: 0.4s;">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-primary-900"><?php echo e($stats['open_rate'] ?? 0); ?>%</p>
                    <div class="flex items-center mt-2">
                        <i class="fas fa-arrow-up text-accent-500 mr-1"></i>
    ...
    <div class="glass-effect rounded-2xl p-8 animate-slide-up" style="animation-delay: 0.6s;">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('campaigns.index')); ?>" class="text-primary-600 hover:text-primary-700 font-medium text-sm transition-colors">
                View All <i class="fas fa-arrow-right ml-1"></i>
            </a>
        </div>

        <?php $__empty_1 = true; $__currentLoopData = $stats['recent_campaigns'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h4 class="font-semibold text-primary-900"><?php echo e($campaign->name); ?></h4>
                                <p class="text-sm text-primary-600"><?php echo e($campaign->created_at->format('M d, Y')); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full
                            <?php if($campaign->status === 'sent'): ?> bg-accent-100 text-accent-800 border border-accent-200
                            <?php elseif($campaign->status === 'sending'): ?> bg-primary-100 text-primary-800 border border-primary-200
                            <?php elseif($campaign->status === 'scheduled'): ?> bg-accent-100 text-accent-700 border border-accent-200
                            <?php else: ?> bg-primary-100 text-primary-700 border border-primary-200 <?php endif; ?>">
                        ...
                        <div class="text-right">
                            <div class="text-lg font-bold text-primary-900"><?php echo e($campaign->sent_count); ?></div>
                            <div class="text-xs text-primary-600">sent</div>
                        </div>

                        <div class="text-right">
                            <div class="text-lg font-bold text-accent-600"><?php echo e($campaign->getOpenRate()); ?>%</div>
                ...
                <?php if($campaign->status === 'sending'): ?>
                    <div class="mt-4">
                        <div class="flex justify-between text-xs text-primary-600 mb-1">
                            ...
                            <span><?php echo e(rand(45, 78)); ?>%</span>
                        </div>
                        <div class="w-full bg-primary-100 rounded-full h-2">
                            <div class="bg-gradient-to-r from-primary-500 to-accent-500 h-2 rounded-full animate-pulse" style="width: <?php echo e(rand(45, 78)); ?>%"></div>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH /Users/user/Desktop/Bulksend Email Only/resources/views/dashboard.blade.php ENDPATH**/ ?>