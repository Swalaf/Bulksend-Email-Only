...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>{{ $metaTitle ?? 'BulkSend - Professional Email Marketing Platform' }}</title>
    <meta name="title" content="{{ $metaTitle ?? 'BulkSend - Professional Email Marketing Platform' }}">
    <meta name="description" content="{{ $metaDescription ?? 'Send bulk emails with ease. Powerful email marketing platform with advanced analytics, automation, and SMTP management. Start your free trial today.' }}">
    ...
    <meta property="og:title" content="{{ $ogTitle ?? 'BulkSend - Professional Email Marketing Platform' }}">
    <meta property="og:description" content="{{ $ogDescription ?? 'Send bulk emails with ease. Powerful email marketing platform with advanced analytics, automation, and SMTP management.' }}">
    ...
    <meta property="twitter:title" content="{{ $ogTitle ?? 'BulkSend - Professional Email Marketing Platform' }}">
    <meta property="twitter:description" content="{{ $ogDescription ?? 'Send bulk emails with ease. Powerful email marketing platform with advanced analytics, automation, and SMTP management.' }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition">Log In</a>
                    <a href="{{ route('register') }}" class="px-5 py-2.5 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition shadow-lg shadow-primary-500/25">Get Started Free</a>
                </div>
        ...
        <div x-show="mobileMenuOpen" class="md:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800" @click.away="mobileMenuOpen = false">
            <div class="px-4 py-4 space-y-3">
                ...
                <div class="pt-4 border-t border-gray-100 dark:border-gray-800 space-y-3">
                    <a href="{{ route('login') }}" class="block py-2 text-center text-gray-600 dark:text-gray-300 font-medium">Log In</a>
                    <a href="{{ route('register') }}" class="block py-3 text-center bg-primary-600 text-white font-semibold rounded-lg">Get Started Free</a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                    <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-4 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 transition shadow-xl shadow-primary-500/25 text-lg">
                        Start Free Trial
    ...
    <section id="how-it-works" class="py-20 lg:py-32">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-16">
                <a href="{{ route('register') }}" class="inline-flex items-center text-primary-600 dark:text-primary-400 font-semibold hover:underline">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="pricing-card bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 text-center border-2 border-primary-600 text-primary-600 font-semibold rounded-xl hover:bg-primary-600 hover:text-white transition">Get Started</a>
                </div>
                ...
                <div class="pricing-card bg-primary-600 rounded-2xl p-8 shadow-xl border-2 border-primary-500 transform scale-105 relative">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 text-center bg-white text-primary-600 font-semibold rounded-xl hover:bg-gray-100 transition">Get Started</a>
                </div>
                ...
                <div class="pricing-card bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-300">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-3 text-center border-2 border-primary-600 text-primary-600 font-semibold rounded-xl hover:bg-primary-600 hover:text-white transition">Contact Sales</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-32 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('register') }}" class="w-full sm:w-auto px-10 py-4 bg-white text-primary-600 font-bold rounded-xl hover:bg-gray-100 transition shadow-xl text-lg">
                    Start Free Trial
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
