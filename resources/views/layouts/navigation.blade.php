<nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold text-gray-800">{{ config('app.name', 'BulkSend') }}</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @if(Auth::user()->role === 'admin')
                        <x-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.*')" class="text-indigo-600">
                            {{ __('Admin') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('smtp.index')" :active="request()->routeIs('smtp.*')">
                {{ __('SMTP') }}
            </x-responsive-nav-link>
